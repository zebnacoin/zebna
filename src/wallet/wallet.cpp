...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/zebnacoin/zebna/pull/10340, but that change has been
    // postponed until after https://github.com/zebnacoin/zebna/pull/10244 to
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-zebna-address
 ...
 * https://zebnatalk.org/?topic=54527, or
 * https://github.com/zebnacoin/zebna/pull/1393.
 */
