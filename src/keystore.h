...
#ifndef ZEBNA_KEYSTORE_H
#define ZEBNA_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/zebnacoin/bips/blob/master/bip-0013.mediawiki
