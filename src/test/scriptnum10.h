...
#ifndef ZEBNA_TEST_SCRIPTNUM10_H
#define ZEBNA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Zebna Core 0.10.0, for cross-comparison.
 */
public:
