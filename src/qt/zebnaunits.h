...
#ifndef ZEBNA_QT_ZEBNAUNITS_H
#define ZEBNA_QT_ZEBNAUNITS_H
...
/** Zebna unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZebnaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZebnaUnits(QObject *parent);

    /** Zebna units.
      @note Source: https://en.zebna.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ZBN,
...
typedef ZebnaUnits::Unit ZebnaUnit;

#endif // ZEBNA_QT_ZEBNAUNITS_H
