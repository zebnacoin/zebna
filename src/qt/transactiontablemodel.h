...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ZebnaUnits::SeparatorStyle separators=ZebnaUnits::separatorStandard) const;
...
#endif // ZEBNA_QT_TRANSACTIONTABLEMODEL_H
