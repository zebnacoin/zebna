    ...
    mapper(0)
{
    ...
    ui->zebnaAtStartup->setToolTip(ui->zebnaAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->zebnaAtStartup->setText(ui->zebnaAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openZebnaConfButton->setToolTip(ui->openZebnaConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ZebnaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->zebnaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openZebnaConfButton_clicked()
{
