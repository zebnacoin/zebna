...
"""Verify that starting zebna with -h works as expected."""

from test_framework.test_framework import ZebnaTestFramework
from test_framework.util import assert_equal

class HelpTest(ZebnaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zebna with -h for help text")
        ...
        self.log.info("Start zebna with -version for version information")
        ...
        self.log.info("Start zebnad with -fakearg to make sure it does not start")
