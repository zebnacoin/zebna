...
# TestP2PConn: A peer we use to send messages to zebnad, and store responses.
...
class CompactBlocksTest(ZebnaTestFramework):
    ...
    # This test actually causes zebnad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that zebnad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for zebnad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # zebnad will not send blocktxn responses for blocks whose height is
