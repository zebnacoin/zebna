...
This document provides guidelines for internationalization of the Zebna Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zebna_en.ts` remains unchanged.
