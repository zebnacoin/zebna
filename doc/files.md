...
* zebna.conf: contains configuration settings for zebnad or zebna-qt
* zebnad.pid: stores the process id of zebnad while running
...
* debug.log: contains debug information and general logging generated by zebnad or zebna-qt
